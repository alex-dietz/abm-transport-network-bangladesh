...
class Bridge(Infra):
    ...
    def __init__(self, unique_id, model, length=0,
                 name='Unknown', road_name='Unknown', condition='Unknown',betweeness=0):        
...
class Sink(Infra):
    ...
    def __init__(self, unique_id, model, length=0,
        ...
        super().__init__(unique_id, model, length, name, road_name)
        # init list to store effective speeds of vehicles
        self.effective_speeds = []
    

    def remove(self, vehicle):
        self.effective_speeds.append(vehicle.effective_speed())
...
class Vehicle(Agent):
    ...
    def effective_speed(self):
        """
        The distance traveled by the vehicle im km/h
        """
        return self.distance_traveled / (self.removed_at_step - self.generated_at_step)*3/50
